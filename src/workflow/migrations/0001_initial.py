...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('workflow_versiongroup', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'children', null=True, to=orm['workflow.VersionGroup'])),
        ...
        db.create_table('workflow_version', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflow.VersionGroup'])),
        ...
        db.send_create_signal('workflow', ['Version'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('workflow_version')
    ...
    models = {
        ...
        'workflow.version': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['workflow.VersionGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'workflow.versiongroup': {
            'Meta': {'ordering': "[u'-date_created']", 'object_name': 'VersionGroup'},
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'children'", 'null': 'True', 'to': "orm['workflow.VersionGroup']"}),
