...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('workflow_revision', 'manager_slug',
                      self.gf('django.db.models.fields.CharField')(default=u'default', max_length=200, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Revision.manager_slug'
        db.delete_column('workflow_revision', 'manager_slug')
