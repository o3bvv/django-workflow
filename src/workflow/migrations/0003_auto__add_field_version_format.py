...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.format'
        db.add_column('workflow_version', 'format',
                      self.gf('django.db.models.fields.CharField')(default='json', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.format'
        db.delete_column('workflow_version', 'format')
